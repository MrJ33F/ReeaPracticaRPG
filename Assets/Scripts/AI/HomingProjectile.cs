...
public class HomingProjectile : Projectile
{
    ...
    public override void Spawn(Vector2 Forward, int Damage, Transform Target)
    {
        this.Damage = Damage;
        this.Target = Target;
    ...
    private IEnumerator FindTarget()
    {
        ...
        while(time < 1)
        {
            ...
            transform.position = Vector3.Lerp(startPosition, Target.position + new Vector3(0, yOffset, 0), PositionCurve.Evaluate(time))
                                 + new Vector3(HorizontalNoiseVector.x * NoisePosition * Noise.x,
